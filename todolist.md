...
While auditing, **reduce verbosity** — consolidate wordy explanations into concise ones, merge redundant sections, cut fluff. Fewer lines = faster context loading = better sessions. But NEVER lose actual research findings, operational rules, or harness instructions in the process. Compress, don't delete knowledge.
