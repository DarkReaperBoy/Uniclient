...
### 2.3 Chat List Rows
- [ ] Row height: 62px (S2)
- [ ] Row padding: 10px left, 8px top, 10px right, 8px bottom (S2)
- [ ] Avatar: 46px diameter at position (10, 8) (S2)
- [ ] Online indicator: 12px green dot (#4dc920) with 3px white stroke, bottom-right of avatar (S2)
...
- [ ] Chat name: x=68px, y=10px, semibold font (S2)
- [ ] Chat name color: #222222 normal, #ffffff active (S2)
- [ ] Chat-type icon before name (bot/channel/forum/group) with 3px skip (S2)
- [ ] Mute icon after name with 4px skip (S2)
- [ ] Verified/scam/fake badges after name (S2)
- [ ] Timestamp: right-aligned, 13px font, #999999 normal, #ffffff active (S2)
- [ ] Timestamp skip from right: 5px (S2)
- [ ] Timestamp formats: "12:30" today, "Yesterday", "Mon" this week, "Jan 15" older (S2)
- [ ] Message preview: x=68px, y=34px, normal ~13px font (S2)
- [ ] Message preview color: #999999 normal, #ffffff active (S2)
- [ ] Sender name prefix in service color (#168acd) (S2)
- [ ] "Draft:" prefix in red (#dd4b39) (S2)
- [ ] Typing indicator: animated dots replacing preview text (S2)
- [ ] Mini media previews: 16px thumbnails in preview (S2)
- [ ] Unread counter pill: 19px height, 5px horizontal padding per side (S2)
- [ ] Unread counter min width = height (19px, circle for single digit) (S2)
- [ ] Unread counter: fully round ends (half-circle caps) (S2)
- [ ] Unread counter font: 12px bold (S2)
- [ ] Unread counter text vertically centered (S2)
- [ ] Unread counter truncation with leading ".." when exceeding allowDigits+1 (S2)
- [ ] Unread pill fills: unmuted = windowBgActive (Telegram blue), muted = #bbbbbb (S2)
- [ ] Unread pill Over and Active color variants (S2)
- [ ] Unread pill text color: #ffffff (S2)
- [ ] Unread pill right-anchored at width - 10px (S2)
- [ ] Unread pill vertical center aligned with message preview line (S2)
...
- [ ] Pin icon: shown when no unreads, right side at textTop position (S2)
...
- [ ] Below-threshold release: spring-back animation ~200ms (S2)
...
- [ ] Menu Bots rows (dynamic per-bot) (S3)
- [ ] New Group row with menuIconGroups (S3)
