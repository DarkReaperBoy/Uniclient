...
| Location / live location | Map thumbnail, "open in maps" | PARTIAL (slice 56: attach-menu Location dialog (lat/lon) → SendLocation map-card bubble w/ open-in-maps; live location streaming + rendered map tiles (GetMapTile) remain engine-gated) | gui/location.go + engine SendLocation/GetMapTile | P2 |
