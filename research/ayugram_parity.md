...
| Poll | Question+options, vote, results bars, retract | PARTIAL (create dialog w/ anonymous/multiple/quiz toggles (CreatePollEx); tappable options, vote bars w/ percentages, quiz reveal, optimistic vote overlay, live count refresh (slice 51); retract-vote / multi-vote / stop-poll remain engine-gated) | gui/poll.go + engine CreatePollEx/VotePoll/mergePollResults | P1 |
