...
| Folder context menu | Edit/delete folder, hide All-chats, import filters | PARTIAL (slice 13: right-click a folder tab → full editor w/ chat picker, flags, emoticon; delete in-editor; slice 85: hide-All — "Hide \"All chats\" tab" in Main settings, persisted HideAllChats; import filters remain) | gui/folders.go + gui/settings.go + engine Create/Edit/DeleteFolder | P2 |
