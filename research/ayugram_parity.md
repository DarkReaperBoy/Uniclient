...
| Attach menu (📎) | Photo/file/poll/location/contact/music menus | PARTIAL (📎 menu: Photo-or-Video + File via OS picker; multi = album; Poll dialog (slice 42); slice 56: Location (lat/lon dialog → SendLocation, map-card bubble) + Contact (contact picker → SendContact, person-card bubble); music later) | gui/attach.go + gui/poll.go + gui/location.go + engine UploadFileEx/SendMediaAlbumFromPaths/CreatePollEx/SendLocation/SendContact | P0 |
