...
| Emoji autocomplete | Keyword suggestions while typing | PARTIAL (emoji-panel keyword search (slice 50, engine GetEmojiKeywords); inline typing autocomplete (`:emoticon:` suggestions in the composer) remains) | gui/emoji.go + engine GetEmojiKeywords | P2 |
