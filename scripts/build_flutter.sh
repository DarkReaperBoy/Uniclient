...
# Generate version.g.dart so Dart code always has the real version
cat > "$DART_DIR/lib/version.g.dart" <<VEOF
// Generated by scripts/build_flutter.sh — do not edit manually.
const kAppVersion = '$APP_VERSION';
const kAppStage = '$APP_STAGE';
const kAppStageNum = '$APP_STAGE_NUM';
const kBuildDate = '$BUILD_DATE';
