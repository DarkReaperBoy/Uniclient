...
class ChatState extends ChangeNotifier {
  ...
  Future<String?> uploadFile(String filePath, {String caption = '', String captionEntities = '', bool silent = false, int scheduleDate = 0, bool spoiler = false, bool sendAsDocument = false, bool captionAbove = false}) async {
    final chat = _activeChat;
    if (chat == null) return null;
    clearOpenedUnread();
    final msgId = await _engine.uploadFile(chat.accountId, chat.chatId, filePath, caption: caption, captionEntities: captionEntities, silent: silent, scheduleDate: scheduleDate, spoiler: spoiler, sendAsDocument: sendAsDocument, captionAbove: captionAbove);
    _refreshMessages();
    return msgId;
  }
