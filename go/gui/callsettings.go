...
func cfgFromAppConfig(c *utils.AppConfig) cfgSnapshot {
	...
	return cfgSnapshot{
		...
		AyuMsgSeconds:          c.AyuMsgSeconds != nil && *c.AyuMsgSeconds,
		AyuFilterZalgo:         c.AyuFilterZalgo != nil && *c.AyuFilterZalgo,
		AyuReactChannels:       c.AyuReactChannels == nil || *c.AyuReactChannels,
		AyuReactGroups:         c.AyuReactGroups == nil || *c.AyuReactGroups,
		AyuReactPrivate:        c.AyuReactPrivate == nil || *c.AyuReactPrivate,
		AyuConfirmSticker:      c.AyuConfirmSticker != nil && *c.AyuConfirmSticker,
		AyuConfirmGif:          c.AyuConfirmGif != nil && *c.AyuConfirmGif,
		AyuConfirmVoice:        c.AyuConfirmVoice != nil && *c.AyuConfirmVoice,
