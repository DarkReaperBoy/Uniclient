...
var (
	...
	iconActionPictureInPicture = mustIcon(icons.ActionPictureInPicture)
	...
	iconActionBookmark         = mustIcon(icons.ActionBookmark)
	iconContentLink            = mustIcon(icons.ContentLink)
	iconMgrUp                  = mustIcon(icons.NavigationArrowUpward)
	iconMgrDown                = mustIcon(icons.NavigationArrowDownward)
	iconMgrArchive             = mustIcon(icons.ContentArchive)
	iconMgrUnarchive           = mustIcon(icons.ContentUnarchive)
	iconToggleCheckBox         = mustIcon(icons.ToggleCheckBox)
	iconToggleCheckBoxBlank    = mustIcon(icons.ToggleCheckBoxOutlineBlank)
