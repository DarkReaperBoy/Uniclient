...
// savedScopeState: the open sublist scope (nil = the whole saved chat).
...
// loadSavedSublists fetches the account's sublists through the engine
// (async — the pane shows an honest loading state meanwhile).
