...
func TestHeaderMenuItemsDM(t *testing.T) {
	t.Run("default", func(t *testing.T) {
		...
		want := []string{"Mute notifications", "View profile", "Search", "Scheduled messages", "Auto-delete…", "Shadow-banned users…", "View deleted messages…", "Clear deleted messages", "Change colors…", "Block user", "Clear history", "Delete chat"}
