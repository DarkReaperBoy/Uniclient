...
// Local zone caches (the upstream //go:linkname tricks into net.zoneCache
// and x/net/internal/socket.zoneCache were rejected by the Go 1.23+ linker
// on android; maintaining private caches is equivalent).
